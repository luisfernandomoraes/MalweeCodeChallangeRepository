...
namespace MalweeCodeChallenge.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        protected AccountController(ApplicationUserManager userManager, ApplicationSignInManager signInManager)
        {
        ...
        public ActionResult Register()
        {
            ...
            var states = from StatesEnum e in Enum.GetValues(typeof(StatesEnum))
                                                    select new SelectListItem
                                                    {
                                                        Value = e.GetHashCode().ToString(),
                                                        Text = e.GetDescription()
                                                    };
            ViewBag.StatesEnum = states.OrderBy(x => x.Text);
            return View();
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    return RedirectToAction("Index", "ServiceProvideds");
                }
                AddErrors(result);
            }
            ...
            ViewBag.StatesEnum = new SelectList(states, "ID", "Name");
